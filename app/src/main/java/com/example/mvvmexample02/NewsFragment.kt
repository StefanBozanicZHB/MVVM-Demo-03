...
import com.example.mvvmexample02.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    private fun setSearchedView() {
        fragmentNewsBinding.swNews.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
...
//                viewSearchedNewsList()
        ...
        fragmentNewsBinding.swNews.setOnCloseListener(object: SearchView.OnCloseListener{
